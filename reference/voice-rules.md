# Voice Rules & Avoid List
## {{YOUR_NAME}} | {{YOUR_NICHE}}

---

## THE VOICE IN ONE SENTENCE

Direct. Personal. Grounded in real work. Never performing expertise — demonstrating it.
...
**Tone:** Like a smart friend explaining something at dinner — not a conference keynote, not a press release. Warm enough to feel human. Sharp enough to feel credible.
...
> Now it takes 11 minutes.
> Here's the only thing that changed.
...
**The reframe:**
> Everyone calls it a soft skill.
...
- delve
- utilize (use "use")
- facilitate (use "run" or "lead" or "help")
- empower (unless there's a very specific reason)
- impactful (say what the impact actually was)
- learnings (use "lessons" or just say what you learned)
- actionable (just say what the action is)
- as always (undercuts authority)
- needless to say (then don't say it)
- it goes without saying (same)
- in conclusion / to summarize (just end)
- touch base
- bandwidth (when used to mean "time/capacity" in a casual context)
- low-hanging fruit
- pivot (unless literally changing direction and it's relevant)

### Forbidden constructions:
- **Em dashes** — never. Use a period, colon, or line break.
- **Starting a LinkedIn post with "I"** — restructure the sentence
...
**Instagram:**
- 3–5 in the caption, slightly warmer than LinkedIn
- First line can have 1 emoji for visual break
- Reels scripts: no emoji in spoken scripts, can use in on-screen text
...
- "If you've navigated this — what actually helped?"
- "Save this for the next time someone asks you to explain [X]."
- "I'd genuinely love to hear how your org is approaching this."
- "Anyone else still figuring this out? → me too."

**Bad:**
- "Drop a comment below!" (too eager)
- "Like this post if you agree!" (desperate)
- "Share with someone who needs to see this!" (transactional)
- "Follow me for more content like this!" (needy)
- "What do you think?" (too open, invites one-word answers)

---

## THE PERSONAL STORY STANDARD

For any post drawing on personal experience, it must pass this test:
